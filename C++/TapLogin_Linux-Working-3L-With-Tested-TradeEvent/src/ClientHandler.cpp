...
ClientHandler::ClientHandler()
{
    ...
    try
    {
        ...
        nn_bind(ClientHandler::ReplySock, "tcp://192.168.168.36:8003");
    }
    catch(int e)
    {
    ...
    try
    {
        ...
        nn_bind(ClientHandler::PubSock,"tcp://192.168.168.36:8002");
    }
    catch(int e)
    {
...
void ClientHandler::Login(char* obj)
{
    ...
    switch(_loginpack.TransectionCode)
    {
        ...
        default:
        {
            ...
            _StgMap[_loginpack.ClintId]->ClientIdAlgo = 201010001772000;
            cout << " Contract loaded successfully "<< cimlist.size() << endl<<endl;
